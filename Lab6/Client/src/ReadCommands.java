...
public class ReadCommands {
    ...
    ReadCommands() throws SocketException {
    }

    void readCom() throws IOException {
        while (!isConnected) {
            isConnected = true;
    ...
    /*public void readCom1() throws IOException {
        while (!isConnected) {
            isConnected = true;
            ArrayList<String> history = new ArrayList<>();
            Scanner cScan = new Scanner(System.in);
            ...
            try {
                while (!command.equals("exit")) {
                    ...
                    switch (lastCommand[0]) {
                        ...
                        case "info":
                            chan = createChannel();
                            outStream = new ObjectOutputStream(chan.socket().getOutputStream());
                            HelpObject info = new HelpObject("info");
                            outStream.writeObject(info);
                            reciever = new Receiving();
                            reciever.receive();
                            chan.close();
                            outStream.close();
                            history.add(command);
                        ...
                        case "updateId":
                            try {
                                ...
                                outStream = new ObjectOutputStream(chan.socket().getOutputStream());
                                HelpObject updateId = new HelpObject("updateId", idd, RouteCreation.createForUpdateId());
                                outStream.writeObject(updateId);
                                reciever = new Receiving();
                                reciever.receive();
                                chan.close();
                                outStream.close();
                        ...
                        case "removeById":
                            try {
                                ...
                                outStream = new ObjectOutputStream(chan.socket().getOutputStream());
                                HelpObject removeById = new HelpObject("removeById", iddd);
                                outStream.writeObject(removeById);
                                reciever = new Receiving();
                                reciever.receive();
                                chan.close();
                                outStream.close();
                        ...
                        case "executeScript":
                            ...
                            outStream = new ObjectOutputStream(chan.socket().getOutputStream());
                            HelpObject executeScript = new HelpObject("executeScript");
                            outStream.writeObject(executeScript);
                            reciever = new Receiving();
                            reciever.receive();
                            chan.close();
                            outStream.close();
                        ...
                        case "addIfMax":
                            ...
                            outStream = new ObjectOutputStream(chan.socket().getOutputStream());
                            HelpObject addIfMax = new HelpObject("addIfMax", RouteCreation.createRoute());
                            outStream.writeObject(addIfMax);
                            reciever = new Receiving();
                            reciever.receive();
                            chan.close();
                            outStream.close();
                        ...
                        case "removeLower":
                            try {
                                ...
                                outStream = new ObjectOutputStream(chan.socket().getOutputStream());
                                HelpObject removeLower = new HelpObject("removeLower", idddd);
                                outStream.writeObject(removeLower);
                                reciever = new Receiving();
                                reciever.receive();
                                chan.close();
                                outStream.close();
                        ...
                        case "history":
                            chan = createChannel();
                            outStream = new ObjectOutputStream(chan.socket().getOutputStream());
                            HelpObject historyy = new HelpObject("history", history.toString());
                            System.out.println(history);
                            outStream.writeObject(historyy);
                            reciever = new Receiving();
                            reciever.receive();
                            chan.close();
                            outStream.close();
                        ...
                        case "filterStartsWithName":
                            try {
                                ...
                                outStream = new ObjectOutputStream(chan.socket().getOutputStream());
                                HelpObject filterStartsWithName = new HelpObject("filterStartsWithName", nnamee);
                                outStream.writeObject(filterStartsWithName);
                                reciever = new Receiving();
                                reciever.receive();
                                chan.close();
                                outStream.close();
                        ...
                        case "filterLessThanDistance":
                            try {
                                ...
                                outStream = new ObjectOutputStream(chan.socket().getOutputStream());
                                HelpObject filterLessThanDistance = new HelpObject("filterLessThanDistance", dist);
                                outStream.writeObject(filterLessThanDistance);
                                reciever = new Receiving();
                                reciever.receive();
                                chan.close();
                                outStream.close();
    ...
    private SocketChannel createChannel() throws IOException {
        ...
        try {
            SocketAddress sa = new InetSocketAddress("localhost", 1111);
